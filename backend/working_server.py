#!/usr/bin/env python3
"""
Working FastAPI server for Glory Boxing Manager
"""
...
# Create FastAPI app
app = FastAPI(
    title="Glory Boxing Manager API",
    description="Professional Boxing Management API",
    version="1.0.0"
)
...
@app.get("/")
async def root():
    return {"msg": "Glory Boxing Manager API running...", "version": "1.0.0"}

# Health check endpoint
@app.get("/health")
async def health():
    return {"status": "healthy", "message": "API is running", "fighters_count": len(fighters), "matches_count": len(matches)}
...
def main():
    print("🚀 Starting Glory Boxing Manager API...")
    print("📍 Server will be available at: http://127.0.0.1:8000")
    print("📚 API Documentation: http://127.0.0.1:8000/docs")
    print("🔐 Authentication token: dev-token")
    print("=" * 50)
